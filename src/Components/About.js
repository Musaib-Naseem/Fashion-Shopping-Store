...
<p className="text-base mt-3 text-sm"><Link className="text-neutral-500 text-sm" to="/" >Home</Link>  <IoIosArrowForward className="inline-block text-sm"/> <span className="text-slate-900 text-sm"> About </span></p>
